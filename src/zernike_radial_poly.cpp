...
static double ZernikeRadialPolynomialDirect(unsigned int n,
                                            unsigned int m,
                                            double r)
{
  ...
  double a_k        = std::pow(-1.0,nmm2)*boost::math::binomial_coefficient<double>(npm2,nmm2);
...
static double ZernikeRadialPolynomialRecursion(unsigned int n,
                                               unsigned int m,
                                               double r)
{
